...
public class Sintaxis{
  ...
  //Retira los espacios de la expresion 
  ...
  //1. Dos o mas operadores estan seguidos.
  ...
  //2. Un parantesis que abre seguido de un operador. Ejemplo: 2-(*3) 
  private boolean parentesisAbreOperador(){
    ...
    for(i=0;i<expr.length()-1;i++){
      ...
      car2 = expr.charAt(i+1); //Extrae el siguiente caracter
      //Compara si el primer caracter es parentesis que abre y el siguiente es operador 
      if (car == '(') if (car2 == '+' || car2 == '-' || car2 == '*' || car2 == '/' || car2 == '^')
        band = true;
    }
    return band;
  }
  //3. Un operador seguido de un parantesis que cierra. Ejemplo: 2-(4+)-7
  ...
  //6. Que los par�ntesis estan desbalanceados. Ejemplo: 3-(2*4))
  ...
  //7. Que haya par�ntesis vacio. Ejemplo: 2-()*3 
  ...
  //9. Un numero seguido de un par�ntesis que abre. Ejemplo: 7-2(5-6)
  ...
  //10. Doble punto en un numero de tipo real. Ejemplo: 3-2..4+1 7-6.46.1+2
  ...
  private boolean numeroLuegoVariable(){ 
    ...
    for(int i=0;i<expr.length()-1;i++){ 
      ...
      if(car1>='0' && car1<='9')
        if( (car2>='a'&& car2<'e') && (car2>'e'&& car2<='z')) 
          band=true; 
    }
    return band;
  }
  ...
  private boolean caracterInvalido(){
    boolean band=false;
    String validos = "Eabcdefghijklmnopqrstuvwxyz0123456789.+-*/^()√";
    //Va de car�cter en caracter
    for(int i=0;i<expr.length();i++){
  ...
  //17. 4 o mas variables seguidas 
  boolean checkFourLetras(){
    boolean band=false;
    ...
    for(int i = 0;i<expr.length()-4;i++){
      ...
      car5 = expr.charAt(i+4);
      if( (car1 >= 'a' && car1 <= 'z') && (car2 >= 'a' && car2 <= 'z') && (car3 >= 'a' && car3 <= 'z') && (car4 >= 'a' && car4 <= 'z') && (car5 >= 'a' && car5 <= 'z') )
        band=true;
    }
    return band;
  }
